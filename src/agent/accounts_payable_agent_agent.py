"""Accounts Payable Agent - Main Agent Implementation."""
...
class AccountsPayableAgentAgent:
    """
    ...
    def __init__(self):
        ...
        self.accounts_enabled = True
        self.payable_enabled = True
        self.compliance_enabled = True
        self.reporting_enabled = True
        self._tool_dispatch = {
            "process_payment_batch": self.tools.process_payment_batch,
            "optimize_payment_timing": self.tools.optimize_payment_timing,
            "apply_early_payment_discount": self.tools.apply_early_payment_discount,
            "reconcile_ap": self.tools.reconcile_ap,
            "generate_aging_report": self.tools.generate_aging_report,
        }
        logger.info(
            "agent_initialized",
            ...
            features=['accounts', 'payable', 'compliance', 'reporting'],
        )
    ...
    async def _maybe_execute_tools(self, message: str, context: str) -> list[dict]:
        ...
        tool_keywords = {
            "process_payment_batch": ['process', 'payment', 'batch'],
            "optimize_payment_timing": ['optimize', 'payment', 'timing'],
            "apply_early_payment_discount": ['apply', 'early', 'payment', 'discount'],
            "reconcile_ap": ['reconcile', 'ap'],
