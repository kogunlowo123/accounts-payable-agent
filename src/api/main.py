"""Accounts Payable Agent - FastAPI Application."""
...
app = FastAPI(
    ...
    description="Accounts payable agent that manages vendor payments, optimizes payment timing for cash flow, processes payment batches, handles early payment discounts, and reconciles AP ledger.",
    version="1.0.0",
    docs_url="/docs",
    redoc_url="/redoc",
    lifespan=lifespan,
