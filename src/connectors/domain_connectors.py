"""Accounts Payable Agent - Domain-Specific Connectors."""
...
class NetsuiteConnector:
    """Domain-specific connector for netsuite integration with Accounts Payable Agent."""
...
class QuickbooksConnector:
    """Domain-specific connector for quickbooks integration with Accounts Payable Agent."""
...
class XeroConnector:
    """Domain-specific connector for xero integration with Accounts Payable Agent."""
...
class SapConnector:
    """Domain-specific connector for sap integration with Accounts Payable Agent."""
...
class OracleFinancialsConnector:
    """Domain-specific connector for oracle financials integration with Accounts Payable Agent."""
